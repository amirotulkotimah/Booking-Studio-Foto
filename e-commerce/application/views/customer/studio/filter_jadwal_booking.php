                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-5 mb-10">
                            ...
                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                ...
                                <span class="fw-semibold">Pilih salah satu waktu booking dengan keterangan status "Free", agar Anda dapat melanjutkan proses booking</span>
                                <!--end::Content-->
                            </div>
                        </div>
                        <!--end::Alert-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= site_url('booking_c/pilih_tanggal/' . '?id=' . $baris->id) ?>"><button type="button" class="btn btn-secondary btn-sm"><?php echo $baris->waktu_booking;?></button></a></td>
                                        <td>
