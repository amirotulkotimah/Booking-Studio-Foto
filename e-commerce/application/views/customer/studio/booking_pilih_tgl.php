                            ...
                            <div class="row">
                              <div class="col-md-15">
                                <div class="form-group pt-5">
                                  ...
                                  <div class="col-sm-14">
                                    <select class="form-control" id="paket" name="produk"  required="">
                                  ...
                                  $('#paket').change(function(){
                                    ...
                                    $.ajax({
                                      ...
                                      success: function(data){
                                        $.each(data,function(harga, harga_tambah_perorang, jumlah_orang, total, ){
                              ...
                              <!--<div class="form-group pt-5">
                                <label for="exampleFormControlInput1" class="required form-label">Harga</label>
                                  <select name="harga" class="harga form-control">
                                    <option value="0"></option>
                                  </select>
                              </div>-->
                                <div class="form-group pt-5">
                                  <label class="required form-label" for="harga" id="harga_asli">Harga</label>
                                  <input type="text" name="harga" id="harga" value="" class="form-control" readonly="">
                                </div>
                                <!--<div class="form-group pt-5">
                                  <label class="required form-label" for="harga" id="promo_harga">Harga Promo</label>
                                  <input type="text" name="harga_promo" id="promo_harga1" value="" class="form-control" readonly="">
                                </div>-->
                                <div class="form-group pt-5">
                                ...
                                <div class="form-group pt-5">
                                  ...
                                  <input type="text" name="jumlah_orang" id="jumlah_orang" value="" class="form-control" readonly="">
                                </div>
                                <div class="form-group pt-5">
                                ...
                                <div class="form-group pt-5">
                                  ...
                                  <input type="date" name="tanggal_order" value="<?=$user['tanggal_booking'];?>" class="form-control" >
                                </div>
                                <div class="form-group pt-5">
                                  <label class="required form-label" for="harga">Waktu</label>
                                  <input type="" name="waktu_booking" value="<?=$user['waktu_booking'];?>" class="form-control" >
                                </div>
                              <div class="form-group pt-5">
                              ...
                              <div class="form-group pt-5">
                                  <label class="required form-label" for="harga">Total Harga</label>
                                    ...
                                    <input type="hidden" name="harga_tambah_perorang" value="" id="harga_tambah_perorang" class="form-control" >
                                        <script type="text/javascript">
                                            $(document).ready(function() {
