		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
					...
					<div class="card-header align-items-center py-5 gap-2 gap-md-5">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1 fw-semibold fs-6">
								...
								<form action="<?php echo site_url('penjualan_c/search_tunai/');?>" method="get">
								<!--end::Svg Icon-->
								<input type="text" class="form-control form-control-solid w-200px ps-10" placeholder="Search" name="id_bayar"/>
				...
				<div class="card-body pt-0">
					<form method="post" action="<?php echo site_url('penjualan_c/delete_tunai/'. '?id_nama_usaha=' . $id_nama_usaha);?>">
										...
										<tr>
											<td>
												<div class="form-check form-check-sm form-check-custom form-check-solid">
													<input class="form-check-input" type="checkbox" name="id_bayar[]" value='<?php echo $baris->id_bayar; ?>'/>
												</div>
											</td>
											...
											<td class="text-end pe-0 text-center"><?php echo date('d-m-Y', strtotime($baris->waktu_bayar));?></td>
											<td class="text-end pe-0 text-center">
												<?php if ($baris->type_bayar == '2') : ?>
                                                <div class="badge badge-light-primary fs-7">Lunas</div>
	                                            <?php endif ?>
											</td>
										</tr>
										</tbody>
