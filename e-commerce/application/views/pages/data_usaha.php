							...
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
								...
								<thead>
									...
									<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
										...
										<th class="min-w-125px fs-7">ID</th>
										<th class="min-w-125px fs-7">Nama Usaha</th>
										<th class="min-w-125px fs-7">WA CS</th>
										<th class="text-end min-w-70px fs-7">Actions</th>
									</tr>
									<!--end::Table row-->
								</thead>
								<!--end::Table head-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">WA CS</label>
                	<input type="text" placeholder="" class="form-control" name="wa_cs" value="" required="">
                </div>
            </div>
...
<div class="modal fade" tabindex="-1" id="edit<?php echo $baris->id_data_usaha; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Edit Data Usaha</h3>
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                	<div class="symbol symbol-50px">
                		<div class="symbol-label fs-2 fw-semibold text-dark">x</div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">WA CS</label>
                	<input type="text" placeholder="" class="form-control" name="wa_cs" value="<?php echo $baris->wa_cs;?>">
                </div>
            </div>
...
<?php foreach($user as $baris): ?>
<form class="user" action="<?php echo site_url('data_usaha_c/delete/');?>" method="post" enctype="multipart/form-data">
