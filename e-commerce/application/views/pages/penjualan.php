				...
				<div class="card card-flush">
					<div class="card-header align-items-center py-5 gap-2 gap-md-5">
						<div class="card-title">
							<!-- <span class="fs-5">Hari ini tanggal <?php echo date('d F Y');?></span> -->
						...
						<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
							<a href="<?php echo site_url('penjualan_c/tambah_data/'. '?id_nama_usaha=' . $id_nama_usaha);?>"  class="btn btn-primary btn-sm">Tambah Data</a>
						</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="table" >
										...
										<tbody class="fw-semibold text-gray-600">
											...
											<tr>
																<!--begin::Checkbox-->
												<!-- <td>
													<form method="post" action="<?php echo site_url('penjualan_c/delete/'. '?id_nama_usaha=' . $id_nama_usaha);?>">
		 										...
		 										<?php if ($id_nama_usaha >= 2) : ?>
												<td class="text-end pe-0 text-center"><a href="<?php echo site_url('penjualan_c/lihat_data_order/'. $baris->kode_order . '?id_nama_usaha=' . $id_nama_usaha);?>"><?php echo $baris->kode_order;?></a></td>
												<?php endif?>
												...
												<td class="text-end pe-0 text-center"><?php echo date('d-m-Y', strtotime($baris->tanggal_order));?></td>
												<?php if ($id_nama_usaha == 1) : ?>
												...
												<td class="text-end pe-0 text-center">
													<?php if ($id_nama_usaha == 1 && $baris->status_order == 'selesai') : ?>
														<form method="post" action="<?php echo site_url('penjualan_c/change/');?>">
													...
													<?php elseif ($id_nama_usaha == 1 && $baris->status_order == 'cancel') : ?>
														<a href="<?= site_url('penjualan_c/change_cancel/' . $baris->kode_order. '?id_nama_usaha=' . $id_nama_usaha) ?>" class="menu-link px-3">
													...
													<?php elseif ($id_nama_usaha == 1 && $baris->status_order == '') : ?>
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<form method="post" action="<?php echo site_url('penjualan_c/forward/');?>">
																<input type="hidden" name="kode_order" value="<?=$baris->kode_order;?>">
																<input type="hidden" name="id_nama_usaha" value="<?=$id_nama_usaha;?>">
															...
															<div class="menu-item px-3">
						                                   	...
						                                   	<div class="menu-item px-3">
						                                        <?php if ($id_nama_usaha == 1 && $baris->status_order == '') : ?>
						                                            <a href="<?= site_url('penjualan_c/forward_cancel/'. $baris->kode_order.'?id_nama_usaha=' . $id_nama_usaha) ?>" ><button type="button"  class="menu-link px-3">
						                                            	Cancel
						                                            </button>
																	</a> 
						                                        <?php endif ?>
														...
														<!--end::Menu-->
												<!-- <?php if ($id_nama_usaha == 1 && $baris->status_order == 'selesai') : ?>
													<a href="<?= site_url('penjualan_c/change/' . $baris->kode_order. '?id_nama_usaha=' . $id_nama_usaha) ?>"><img src="<?php echo base_url('assets/media/logos/checkmark-16.png');?>"  /></a>
		                                        <?php elseif ($id_nama_usaha == 1 && $baris->status_order == '') : ?>
		                                            <a href="<?= site_url('penjualan_c/forward/'. $baris->kode_order.'?id_nama_usaha=' . $id_nama_usaha) ?>">
		                                    	...
		                                    	<td class="text-end pe-0 text-center">
		                                        	...
		                                        	<img src="<?php echo base_url('assets/media/logos/delete.jpg');?>" class="w-15px"></a>
		                                        </td>
												<?php if ($id_nama_usaha >= 2) : ?>
											...
											<!-- <tfoot class="fw-semibold text-gray-600">
												<tr>
													<th>
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
															<div class="menu-item px-3">
																<button type="button" class="btn btn-sm" type="button">Delete</button>
															</div>
														</div>
													</th>
												</tr>
