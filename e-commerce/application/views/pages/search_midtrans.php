		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Pembayaran Non Tunai <?= $lihat['nama_usaha'] ?></h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
								...
								<?php foreach ($user as $baris) { ?>
									<tbody class="fw-semibold text-gray-600">
										<tr>
											...
											<td class="text-end pe-0 text-center"><?php echo strtoupper($baris->bank);?></td>
											...
											<td class="text-end pe-0 text-center">
	                                            ...
	                                            <?php elseif ($baris->status_code == '201') : ?>
	                                                <div class="badge badge-light-danger fs-7">Belum Terbayar</div>
	                                            <?php endif ?>
											</td>
