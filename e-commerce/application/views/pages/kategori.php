                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px fs-7">Nama Kategori</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="" class="form-control" name="nama_kategori" value="" required="">
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="exampleFormControlInput1" class="required form-label">Nama Kategori</label>
                    <input type="text" placeholder="" class="form-control" name="nama_kategori" value="<?php echo $baris->nama_kategori;?>">
