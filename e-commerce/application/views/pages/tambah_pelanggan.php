    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
      <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
          <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Pelanggan Form</h1>
              <!--begin::Breadcrumb-->
              ...
              <!--end::Item-->
              <!--begin::Item-->
              <li class="breadcrumb-item text-muted">Tambah Pelanggan</li>
              <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
  <div id="kt_app_content_container" class="app-container container-xxl">
    <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="#" class="user" action="<?php echo site_url('pelanggan_c/input/'. '?id_nama_usaha=' . $id_nama_usaha);?>" method="post" enctype="multipart/form-data">
          ...
          <div class="card-body pt-1">
            <div class="mb-10 fv-row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="required form-label" for="hp">No.HP</label>
                    <div class="input-group mb-14">
                      <span class="input-group-text">+</span>
                      <input class="form-control" type="text" value="" name="hp" placeholder="6282145167189">
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer d-flex justify-content-end py-6 px-9 pt-10">
                <a href="<?php echo site_url('pelanggan_c/data_pelanggan/'. '?id_nama_usaha=' . $id_nama_usaha);?>"><button type="button" class="btn btn-danger btn-sm">&nbspBatal&nbsp</button></a>&nbsp
