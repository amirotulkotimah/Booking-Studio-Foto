...
<form class="form-horizontal" action="<?php echo site_url('login_c/cek_log');?>" method="POST">
            ...
            <div class="row d-flex">
                <div class="col-lg-6">
                    <div class="card1 pb-5">
                        ...
                        <br>
                        <br>
                        <div class="row px-3 justify-content-center mt-4 mb-3 border-line"> <img src="<?php echo base_url('assets/media/logos/logo_nix.png');?>" class="image" > </div>
                    </div>
                </div>
